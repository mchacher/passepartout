...
const en: Record<string, string> = {
  ...
  "export.paper": "Paper",
  "export.coverType": "Cover type",
  "export.coverSoftcover": "Softcover",
  "export.coverDustJacket": "Hardcover, dust jacket",
  "export.coverImageWrap": "Hardcover, ImageWrap",
  "export.targetPage": "Page PDF",
  "export.targetCover": "Cover PDF",
  "export.blankLeaf": "One blank leaf is added at the end: Blurb only accepts an even page count.",
  "export.tooFewPages": "Blurb needs at least 20 interior pages.",
  "export.spineMm": "Spine (mm)",
  "export.spineHint": "From Blurb's specifications for this size, cover and page count. Paste the exact spine width from its spec tool to override.",
  ...
  // Notes (spec 039): a freely placed text block on a page or a cover face.
  "note.add": "Note",
  "note.addTitle": "Add a note to this page",
  "note.placeholder": "Type a note",
  "note.hint": "Drag to move, double click to write.",
  "note.widthHandle": "Drag to set where the text wraps",
  "note.close": "Close picker",
  "note.fontTitle": "Choose the typeface",
  "note.regular": "N",
  "note.regularTitle": "Regular",
  "note.italic": "I",
  "note.italicTitle": "Italic",
  "note.noItalic": "This typeface has no italic",
  "note.bold": "B",
  "note.boldTitle": "Bold",
  "note.size": "Size",
  "note.sizeTitle": "Text size",
  "note.ink": "Ink",
  "note.inkTitle": "Ink and paper reserve",
  "note.ink.ink": "Ink",
  "note.ink.inkSoft": "Soft ink",
  "note.ink.accent": "Accent",
  "note.ink.paper": "Paper white",
  "note.ink.custom": "Custom color",
  "note.reserve": "Paper reserve",
  "note.reserveTitle": "A paper block behind the text, to stay legible over a photo",
  "note.align.left": "Align left",
  "note.align.center": "Align center",
  "note.align.right": "Align right",
  "note.effects": "Style",
  "note.effectsTitle": "Small caps, rule, opacity",
  "note.caps": "Caps",
  "note.capsTitle": "Uppercase, letters spaced out",
  "note.rule.over": "Rule above",
  "note.rule.under": "Rule below",
  "note.tiltTitle": "Tilt the note (decorative)",
  "note.delete": "Delete",
...
const fr: Record<string, string> = {
  ...
  "export.paper": "Papier",
  "export.coverType": "Type de couverture",
  "export.coverSoftcover": "Couverture souple",
  "export.coverDustJacket": "Rigide, jaquette",
  "export.coverImageWrap": "Rigide, ImageWrap",
  "export.targetPage": "PDF des pages",
  "export.targetCover": "PDF de couverture",
  "export.blankLeaf": "Une feuille blanche est ajoutée à la fin : Blurb n'accepte qu'un nombre de pages pair.",
  "export.tooFewPages": "Blurb exige au moins 20 pages intérieures.",
  "export.spineMm": "Dos (mm)",
  "export.spineHint": "D'après les spécifications Blurb pour cette taille, cette couverture et ce nombre de pages. Collez la largeur exacte du dos depuis l'outil Blurb pour la remplacer.",
  ...
  // Notes (spec 039): a freely placed text block on a page or a cover face.
  "note.add": "Note",
  "note.addTitle": "Ajouter une note sur cette page",
  "note.placeholder": "Écrivez une note",
  "note.hint": "Glissez pour déplacer, double-cliquez pour écrire.",
  "note.widthHandle": "Glissez pour régler où le texte revient à la ligne",
  "note.close": "Fermer le sélecteur",
  "note.fontTitle": "Choisir la police",
  "note.regular": "N",
  "note.regularTitle": "Normal",
  "note.italic": "I",
  "note.italicTitle": "Italique",
  "note.noItalic": "Cette police n'a pas d'italique",
  "note.bold": "G",
  "note.boldTitle": "Gras",
  "note.size": "Taille",
  "note.sizeTitle": "Taille du texte",
  "note.ink": "Encre",
  "note.inkTitle": "Encre et réserve papier",
  "note.ink.ink": "Encre",
  "note.ink.inkSoft": "Encre douce",
  "note.ink.accent": "Accent",
  "note.ink.paper": "Blanc papier",
  "note.ink.custom": "Couleur libre",
  "note.reserve": "Réserve papier",
  "note.reserveTitle": "Un aplat papier derrière le texte, pour rester lisible sur une photo",
  "note.align.left": "Aligner à gauche",
  "note.align.center": "Centrer",
  "note.align.right": "Aligner à droite",
  "note.effects": "Style",
  "note.effectsTitle": "Petites capitales, filet, opacité",
  "note.caps": "Capitales",
  "note.capsTitle": "Majuscules, lettres espacées",
  "note.rule.over": "Filet au-dessus",
  "note.rule.under": "Filet au-dessous",
  "note.tiltTitle": "Incliner la note (décoratif)",
  "note.delete": "Supprimer",
  "note.deleteTitle": "Supprimer cette note",
};
